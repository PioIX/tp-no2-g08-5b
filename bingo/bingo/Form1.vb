Public Class frmBingo
    ...
    Private Sub Btn81_Click(sender As Object, e As EventArgs) Handles btn81.Click
        If btn81.BackColor = Color.Violet Then
            btn81.BackColor = Color.White
            LBIngresados.Items.Remove(btn81.Text)

        Else
            btn81.BackColor = Color.Violet
            LBIngresados.Items.Add(btn81.Text)

        End If
    End Sub

    Private Sub Btn82_Click(sender As Object, e As EventArgs) Handles btn82.Click
        If btn82.BackColor = Color.Violet Then
            btn82.BackColor = Color.White
            LBIngresados.Items.Remove(btn82.Text)

        Else
            btn82.BackColor = Color.Violet
            LBIngresados.Items.Add(btn82.Text)

        End If
    End Sub

    Private Sub Btn83_Click(sender As Object, e As EventArgs) Handles btn83.Click
        If btn83.BackColor = Color.Violet Then
            btn83.BackColor = Color.White
            LBIngresados.Items.Remove(btn83.Text)

        Else
            btn83.BackColor = Color.Violet
            LBIngresados.Items.Add(btn83.Text)

        End If
    End Sub

    Private Sub Btn84_Click(sender As Object, e As EventArgs) Handles btn84.Click
        If btn84.BackColor = Color.Violet Then
            btn84.BackColor = Color.White
            LBIngresados.Items.Remove(btn84.Text)

        Else
            btn84.BackColor = Color.Violet
            LBIngresados.Items.Add(btn84.Text)

        End If
    End Sub

    Private Sub Btn85_Click(sender As Object, e As EventArgs) Handles btn85.Click
        If btn85.BackColor = Color.Violet Then
            btn85.BackColor = Color.White
            LBIngresados.Items.Remove(btn85.Text)

        Else
            btn85.BackColor = Color.Violet
            LBIngresados.Items.Add(btn85.Text)

        End If
    End Sub

    Private Sub Btn86_Click(sender As Object, e As EventArgs) Handles btn86.Click
        If btn86.BackColor = Color.Violet Then
            btn86.BackColor = Color.White
            LBIngresados.Items.Remove(btn86.Text)

        Else
            btn86.BackColor = Color.Violet
            LBIngresados.Items.Add(btn86.Text)

        End If
    End Sub

    Private Sub Btn87_Click(sender As Object, e As EventArgs) Handles btn87.Click
        If btn87.BackColor = Color.Violet Then
            btn87.BackColor = Color.White
            LBIngresados.Items.Remove(btn87.Text)

        Else
            btn87.BackColor = Color.Violet
            LBIngresados.Items.Add(btn87.Text)

        End If
    End Sub

    Private Sub Btn88_Click(sender As Object, e As EventArgs) Handles btn88.Click
        If btn88.BackColor = Color.Violet Then
            btn88.BackColor = Color.White
            LBIngresados.Items.Remove(btn88.Text)

        Else
            btn88.BackColor = Color.Violet
            LBIngresados.Items.Add(btn88.Text)

        End If
    End Sub

    Private Sub Btn89_Click(sender As Object, e As EventArgs) Handles btn89.Click
        If btn89.BackColor = Color.Violet Then
            btn89.BackColor = Color.White
            LBIngresados.Items.Remove(btn89.Text)

        Else
            btn89.BackColor = Color.Violet
            LBIngresados.Items.Add(btn89.Text)

        End If
    End Sub

    Private Sub Btn90_Click(sender As Object, e As EventArgs) Handles btn90.Click
        If btn90.BackColor = Color.Violet Then
            btn90.BackColor = Color.White
            LBIngresados.Items.Remove(btn90.Text)

        Else
            btn90.BackColor = Color.Violet
            LBIngresados.Items.Add(btn90.Text)

        End If
    End Sub

    Private Sub Btn91_Click(sender As Object, e As EventArgs) Handles btn91.Click
        If btn91.BackColor = Color.Violet Then
            btn91.BackColor = Color.White
            LBIngresados.Items.Remove(btn91.Text)

        Else
            btn91.BackColor = Color.Violet
            LBIngresados.Items.Add(btn91.Text)

        End If
    End Sub

    Private Sub Btn92_Click(sender As Object, e As EventArgs) Handles btn92.Click
        If btn92.BackColor = Color.Violet Then
            btn92.BackColor = Color.White
            LBIngresados.Items.Remove(btn92.Text)

        Else
            btn92.BackColor = Color.Violet
            LBIngresados.Items.Add(btn92.Text)

        End If
    End Sub

    Private Sub Btn93_Click(sender As Object, e As EventArgs) Handles btn93.Click
        If btn93.BackColor = Color.Violet Then
            btn93.BackColor = Color.White
            LBIngresados.Items.Remove(btn93.Text)

        Else
            btn93.BackColor = Color.Violet
            LBIngresados.Items.Add(btn93.Text)

        End If
    End Sub

    Private Sub Btn94_Click(sender As Object, e As EventArgs) Handles btn94.Click
        If btn94.BackColor = Color.Violet Then
            btn94.BackColor = Color.White
            LBIngresados.Items.Remove(btn94.Text)

        Else
            btn94.BackColor = Color.Violet
            LBIngresados.Items.Add(btn94.Text)

        End If
    End Sub

    Private Sub Btn95_Click(sender As Object, e As EventArgs) Handles btn95.Click
        If btn95.BackColor = Color.Violet Then
            btn95.BackColor = Color.White
            LBIngresados.Items.Remove(btn95.Text)

        Else
            btn95.BackColor = Color.Violet
            LBIngresados.Items.Add(btn95.Text)

        End If
    End Sub

    Private Sub Btn96_Click(sender As Object, e As EventArgs) Handles btn96.Click
        If btn96.BackColor = Color.Violet Then
            btn96.BackColor = Color.White
            LBIngresados.Items.Remove(btn96.Text)

        Else
            btn96.BackColor = Color.Violet
            LBIngresados.Items.Add(btn96.Text)

        End If
    End Sub

    Private Sub Btn97_Click(sender As Object, e As EventArgs) Handles btn97.Click
        If btn97.BackColor = Color.Violet Then
            btn97.BackColor = Color.White
            LBIngresados.Items.Remove(btn97.Text)

        Else
            btn97.BackColor = Color.Violet
            LBIngresados.Items.Add(btn97.Text)

        End If
    End Sub

    Private Sub Btn98_Click(sender As Object, e As EventArgs) Handles btn98.Click
        If btn98.BackColor = Color.Violet Then
            btn98.BackColor = Color.White
            LBIngresados.Items.Remove(btn98.Text)

        Else
            btn98.BackColor = Color.Violet
            LBIngresados.Items.Add(btn98.Text)

        End If
    End Sub

    Private Sub Btn99_Click(sender As Object, e As EventArgs) Handles btn99.Click
        If btn99.BackColor = Color.Violet Then
            btn99.BackColor = Color.White
            LBIngresados.Items.Remove(btn99.Text)

        Else
            btn99.BackColor = Color.Violet
            LBIngresados.Items.Add(btn99.Text)
